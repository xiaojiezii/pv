...
require('echarts/lib/component/title');
  export default {
    ...
    methods:{
       ...
       get(){
             var url=this.global.url+"/custom/countAgeByProject?id="+this.siteId;
            ...
            var url1=this.global.url+"/custom/countCharacterByProject?id="+this.siteId;
             ...
             var url2=this.global.url+"/custom/countTypeByProject?id="+this.siteId;
             ...
             var url3=this.global.url+"/custom/countWeekByProject?id="+this.siteId;
