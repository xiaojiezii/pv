module.exports = {
    ...
    btn:{
        tips:"Note: since the selected report is a 'post-listing report', two evaluation sources must be created from the 'initial reporter' and the 'listing license holder'",
        dateils:'Dateils', 
        edtiot:'Edtiot',
        delete:'Delete',
        ...
        clo:'Close the other',
        sumTag:'Close all',
        homeBtn:'Back to Caselist',
        oper:'operation',
        enter:'Please enter',
        enternum:'Please enter the number',
        chinese:'Please enter the chinese',
        iphone:'Please enter the patients mobile phone number',
     ...
     case:{
        ...
        country1:'China',
        country2:'America',
        casesource:'C.1.CN.1 The report source',
        classify:'C.1.CN.2 Classification of the report',
        holder:'C.1.CN.3 Holder identification',
        classify1:'Domestic pre-listing report',
        classify2:'Report after domestic listing',
        classify3:'Overseas pre-listing report',
        classify4:'Report after overseas listing',
        casestatus:'Reported status',
        casesta:'Status',
        caseproduct:'Product type ',
        caseisyes:'Yes',
        caseisno:'No',
        qiye:'Responsible organ',
        casetype1:'Spontaneous report',
        casetype2:'Reports from research',
        casetype3:'Other',
        casetype4:'Sender cannot know (unknown)',
        casesource1:'Regulator',
        casesource2:'Patients/relatives',
        casesource3:'Medical Institutions ',
        casesource4:'Conduct an enterprise',
        casesource5:'Literature (full text attached)',
        casesource6:'Study (referring to the adverse reaction report from the post-marketing study)',
        casesource7:'Project (refers to the adverse reaction report from the market project for patients or doctors, etc.)',
        casesource8:'Other',
    ...
    repo:{
        ...
        rereemail:'Reporter email address(C.2.r.CN.1)',
    ...
    newList:{
        ...
        nation:'D.CN.1 Nation',
        listage:'D.2.2b Age at time of reaction/event (unit)',
        race:'D.CN.2 Race',
        medicalName:'D.CN.3 Name of medical institution',
        nationality:'D.CN.4 Nationality',
        iphone:'D.CN.5 Patients with the phone',
        pregnancyDescribe:'D.CN.6 Pregnancy related description',
        race1:'East Asian race (yellow race)',
        race2:'Caucasian (Caucasian)',
        race3:'Negro race (black race)',
        race4:'Australian race (brown race)',
        listage1:'Year',
        listage2:'Month',
        listage3:'Week',
        listage4:'Day',
    ...
    druginfo:{
        ...
        isUnexpected:'G.k.9.i.CN.1 Is it unexpected',
        isDisappear :'Does the reaction disappear or decrease after withdrawal or reduction?',
        commonName:'G.k.CN.1 Common name',
        relatedEquipment:'G.k.CN.2 Related equipment',
        isProduct:'G.k.CN.3 Is it the owners product (repeat as necessary)',
        approvalNumber:'G.k.CN.4 Approval number/acceptance number',
        isDisappear1:'Yes',
        isDisappear2:'No',
        isDisappear3:'not quite clear',
        isDisappear4:'Not Applicable',
    ...
    dose:{
        ...
        expiryDate:'G.k.4.r.CN.1 Expiry date/expiry date',
    ...
    evalua:{
        ...
        evsource:'G.k.9.i.2.r.1.CN.1 -Initial reporter/listing license holder evaluation source',
    ...
    event:{
        ...
        evsource1:'Initial reporter',
        evsource2:'Listing permit holder',
        evmethod:'G.k.9.i.2.r.2 Assessment method',
        evmethod1:'Global internal audit algorithm',
        evmethod2:'Bayesian Arithmetic',
        evmethod3:'Arithmetic',
        evassess:'G.k.9.i.2.r.1.CN.3 Assessment result',
        evassess1:'Affirm ',
        evassess2:'May well ',
        evassess3:'Possible',
        evassess4:'May has nothing to do',
        evassess5:'Invaluably',
        evassess6:'Remain to be evaluated ',
    ...
    tishi:{
        ...
        B14:'This data element is used to identify the nationality of the patient',
        B15:'This data element is used to identify the race of the patient',
        B16:'This data element is used to record the name of the medical institution or the medical institution/business that the patient informed of the adverse reaction',
        B17:'This data element is used to record the nationality of the patient',
        B18:'This data element is used to record patient calls',
        B19:'Previous pregnancy history, single pregnancy, multiple pregnancy, pregnancy outcome, mode of birth, and fetal outcome can be reported.This applies only to mothers',
        ...
        J18:'The data element indicates whether the adverse reaction was unexpected',
        J19:'This data element represents the generic name of the drug',
        J20:'This data element represents device information that may be associated with adverse reactions',
        J21:'This element is used to record whether the product in the report is the owners product',
        J22:'This element is used to record the approval number of a drug or the acceptance number of an application for approval of a clinical trial in China',
        ...
        Q12:'The data element represents the source of the evaluation results in G.k.9.i.2.r.1 cn.3',
