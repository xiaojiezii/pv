                ...
                <tr>
                    ...
                    <td align="left"> 
                          <span v-if="prt.assesss!=='1'">
                           <input type="checkbox">肯定
                        </span>
                        <span v-else>
                           <input type="checkbox" checked=true>肯定
                        </span>
                        <span v-if="prt.assesss!=='2'">
                           <input type="checkbox">很可能
                        </span>
                        <span v-else>
                           <input type="checkbox" checked=true>很可能
                        </span>
                        <span v-if="prt.assesss!=='3'">
                           <input type="checkbox">可能
                        </span>
                        <span v-else>
                           <input type="checkbox" checked=true>可能
                        </span>
                        ...
                        <span v-if="prt.assesss!=='5'">
                           <input type="checkbox">无法评价
                        </span>
                        <span v-else>
                           <input type="checkbox" checked=true>无法评价     
                        </span> <br><br>
                        <span v-if="prt.assesss!=='6'">
                           <input type="checkbox">待评价
                        </span>
                        <span v-else>
                           <input type="checkbox" checked=true>待评价
                        </span>
                    </td>
                </tr>
                <tr>
